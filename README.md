...
```js
var ethereumMulticall = require('@oraichain/ethereum-multicall');
```

### JavaScript (ES5 or ES6)

```js
const ethereumMulticall = require('@oraichain/ethereum-multicall');
```
...
import {
  ...
  ContractCallResults,
  ContractCallContext,
} from '@oraichain/ethereum-multicall';
```
